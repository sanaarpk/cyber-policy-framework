...
No Waiver may be approved as permanent. Every Waiver carries an expiry date; a Waiver with no planned remediation path should be escalated through the [Risk Acceptance Process](./risk-acceptance-process.md) instead — a separate governance decision, not a Waiver renewal.
